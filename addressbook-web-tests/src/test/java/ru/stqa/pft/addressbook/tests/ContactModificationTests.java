...
public class ContactModificationTests extends TestBase {
  ...
  public void testContactsModification() {
    ...
    Contact modifyContact=before.iterator().next();
    Contact contact = new Contact().withId(modifyContact.getId()).withFirstName("liza").withLastName("null");
    app.getContactsHelper().modify(contact);
    app.goTo().homePage();
